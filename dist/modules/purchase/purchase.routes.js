...
purchaseRoutes.patch('/:id', (0, verifyAuth_1.authorizeRoles)('ADMIN', 'ACCOUNTANT'), (0, validateRequest_1.default)(purchase_validator_1.default.updateSchema), purchase_controller_1.default.update);
