...
productRoute.post('/', (0, verifyAuth_1.authorizeRoles)('KEEPER', 'ADMIN', 'ACCOUNTANT'), product_controllers_1.default.create);
productRoute.get('/updated', verifyAuth_1.verifyAuth, (0, verifyAuth_1.authorizeRoles)('ADMIN', 'KEEPER', 'ACCOUNTANT'), product_controllers_1.default.getCollectionDiscrepancies);
// productRoute.get('/', productControllers.readAll);
productRoute.patch('/:id/add', (0, verifyAuth_1.authorizeRoles)('KEEPER', 'ADMIN', 'ACCOUNTANT'), (0, validateRequest_1.default)(product_validator_1.default.addStockSchema), product_controllers_1.default.addStock);
productRoute.patch('/:id', (0, verifyAuth_1.authorizeRoles)('KEEPER', 'ADMIN', 'ACCOUNTANT'), (0, validateRequest_1.default)(product_validator_1.default.updateSchema), product_controllers_1.default.updateProduct);
productRoute.get('/:id', product_controllers_1.default.readSingle);
productRoute.delete('/:id', (0, verifyAuth_1.authorizeRoles)('ADMIN', 'ACCOUNTANT'), product_controllers_1.default.delete);
