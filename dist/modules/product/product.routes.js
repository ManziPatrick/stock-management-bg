...
productRoute.get('/updated', verifyAuth_1.verifyAuth, (0, verifyAuth_1.authorizeRoles)('ADMIN', 'KEEPER'), product_controllers_1.default.getCollectionDiscrepancies);
...
productRoute.patch('/:id', (0, verifyAuth_1.authorizeRoles)('KEEPER', 'ADMIN'), (0, validateRequest_1.default)(product_validator_1.default.updateSchema), product_controllers_1.default.updateProduct);
