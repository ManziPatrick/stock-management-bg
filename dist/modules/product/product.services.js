...
class ProductServices extends baseServices_1.default {
    ...
    /**
     * Get all user IDs that should have access to a product:
     * - The current user
     * - Users created by the current user
    ...
    update(id, payload, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const updatedProduct = yield this.model.findByIdAndUpdate(id, Object.assign(Object.assign(Object.assign(Object.assign({}, payload), (payload.seller && { seller: new mongoose_1.Types.ObjectId(payload.seller) })), (payload.category && { category: new mongoose_1.Types.ObjectId(payload.category) })), (payload.brand && { brand: new mongoose_1.Types.ObjectId(payload.brand) })), { new: true, session }).populate(['category', 'brand', 'seller']);
                if (!updatedProduct) {
