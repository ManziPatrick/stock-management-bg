...
class ProductControllers {
    constructor() {
        ...
        this.create = [
            ...
            (0, asyncHandler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    const productData = Object.assign(Object.assign({ name: req.body.name, seller: new mongoose_1.Types.ObjectId(req.body.seller), category: new mongoose_1.Types.ObjectId(req.body.category) }, (req.body.brand && { brand: new mongoose_1.Types.ObjectId(req.body.brand) })), { price: Number(req.body.price), stock: Number(req.body.quantity), description: req.body.description, unit: req.body.unit, measurement: measurement, images: imageUrls, user: new mongoose_1.Types.ObjectId(req.user._id), createdBy: new mongoose_1.Types.ObjectId(req.user._id) // Explicitly set the creator
                     });
                    const result = yield this.services.create(productData, req.user._id);
        ...
        this.updateProduct = (0, asyncHandler_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield product_services_1.default.update(id, payload, {
                updatePurchases,
                userId: req.user._id
            });
            (0, sendResponse_1.default)(res, {
