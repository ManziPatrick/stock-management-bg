    ...
    readAllDaily(query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                console.log('Debug - userId as ObjectId:', new mongoose_1.Types.ObjectId(userId));
                ...
                const sales = yield this.model.find(salesQuery).lean();
                ...
                const allUserSales = yield this.model.find({
                    user: new mongoose_1.Types.ObjectId(userId),
                    date: {
                        $gte: startDateTime,
                        $lte: endDateTime
    ...
    readAllMonthly(query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const monthlyStats = yield this.getMonthlyStats(Object.assign(Object.assign({}, matchStage), { $match: Object.assign(Object.assign({}, matchStage.$match), { status: { $in: ['approved', 'credit'] } }) }));
