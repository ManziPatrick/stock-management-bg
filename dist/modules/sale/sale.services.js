...
class SaleServices extends baseServices_1.default {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const saleTransaction = yield sale_model_1.default.create(Object.assign({ user: userId, buyerName: payload.buyerName, date: saleDate, paymentMode: payload.paymentMode, paymentDetails: payload.paymentDetails, products: processedProducts, transactionId,
                    ...
                    intendedAsCreditSale: payload.status === 'credit' }, (payload.debitDetails && {
    ...
    readAllDaily(query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const startDateTime = startDate ? new Date(startDate) : new Date(new Date().setDate(new Date().getDate() - 30)); // Default to last 30 days
            ...
            const matchStage = {
                $match: {
                    ...
                    status: { $in: ['approved', 'pending', undefined, null] }
                }
            };
            try {
                const dailyStats = yield this.getDailyStats(matchStage);
    ...
    readAllMonthly(query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const monthlyStats = yield this.getMonthlyStats(matchStage);
            ...
            try {
                ...
                if (oldSale.status === 'credit' && status !== 'credit') {
                    ...
                    if (existingDebit) {
                        ...
                        if (status === 'approved') {
                            yield debits_models_1.DebitModel.findByIdAndUpdate(existingDebit._id, {
                                $set: {
                                    status: 'COMPLETED',
                        ...
                        // If sale is being rejected, delete the debit record
                            ...
                            yield debits_models_1.DebitModel.findByIdAndDelete(existingDebit._id);
                        }
                    }
                }
                // Update sale status
                const updatedSale = yield this.model.findByIdAndUpdate(id, { $set: { status } }, { new: true });
                if (!updatedSale) {
                    throw new customError_1.default(404, 'Sale not found');
                }
                return updatedSale;
    ...
    readAllYearly(query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const yearlyStats = yield this.getYearlyStats(matchStage);
